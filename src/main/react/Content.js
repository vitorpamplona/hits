            ...
            <div className="flex flex-wrap">
                <div className="w-full px-6 pb-5">
                    <div className="relative w-full">
                        ...
                        <input id="url" className="w-full text-gray-600 dark:text-gray-400 focus:outline-none focus:border focus:border-indigo-700 dark:focus:border-indigo-700 dark:border-gray-700 dark:bg-gray-800 bg-white font-normal h-10 flex items-center pl-16 text-base border-gray-300 rounded border shadow" placeholder="fc631ff9b18820643a422b00c4228ad165f9440dbb36710425d994be79a36833" value={url} onChange={handleUrlChange} autoFocus />
                    </div>
                </div>
